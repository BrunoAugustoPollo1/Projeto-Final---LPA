...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int], tempo_fase: int):
        self.tempo_fase = tempo_fase
        self.timeout = tempo_fase
        self.window = window
        self.name = name
    ...
    def run(self, player_score: list[int], inimigos: list[str]):
